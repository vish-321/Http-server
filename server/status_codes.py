...
def status_200 (requested_path, connectionSocket ,request,log):
...
def status_201 ( connectionSocket ,request,log):
...
def status_202 ( connectionSocket ,request,log):
...
def status_204 ( connectionSocket ,request,log):
...
def status_301 ( connectionSocket ,request,log):
...
def status_302 ( connectionSocket ,request,log ):
...
def status_304 ( requested_path,connectionSocket ,request,log ):
